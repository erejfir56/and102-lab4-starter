...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Get the Campground object passed via the Intent
        val campground = intent.getSerializableExtra(CAMPGROUND_EXTRA) as Campground

        // Set the name, description, and location information
        ...
        // Load the campground image using Glide
        Glide.with(this)
